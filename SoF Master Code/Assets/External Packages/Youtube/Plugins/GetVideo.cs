...
/*	void OnGUI()
    ...
    public void OnClick()
    {
        ...
        Handheld.PlayFullScreenMovie(YoutubeVideo.Instance.RequestVideo(videoId, 360), Color.black, FullScreenMovieControlMode.Minimal); //if the second parameter is 0 will use the YoutubeVideo.cs quality settings
#endif
        }
}
