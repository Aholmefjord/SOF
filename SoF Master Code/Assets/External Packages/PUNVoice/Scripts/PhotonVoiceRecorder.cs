...
using DemoVoice = ExitGames.Demos.DemoPunVoice;
/// <summary>
...
{
    public Voice.LocalVoice voice = Voice.LocalVoice.Dummy;
    ...
    void Start()
    {
        ...
        {
            var pvs = PhotonVoiceSettings.Instance;
            GameObject.FindGameObjectWithTag("VoiceTransmitter").GetComponent<DemoVoice.PushToTalkScript>().rec = this;
            Application.RequestUserAuthorization(UserAuthorization.Microphone);
