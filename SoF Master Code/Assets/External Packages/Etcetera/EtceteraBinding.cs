...
public class EtceteraBinding
{
    ...
    public static IEnumerator takeScreenShot( string filename )
    {
		...
		if( UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPad3Gen || UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPadUnknown )
