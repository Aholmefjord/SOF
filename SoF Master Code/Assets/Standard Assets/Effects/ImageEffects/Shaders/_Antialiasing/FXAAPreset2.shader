...
// OR IMPLIED, INCLUDING, BUT WCT LIMITED  TO, IMPLIED WARRANTIES OF MERCHANTABILITY
// AND FITNESS FOR A PARTICULAR PURPOSE.  IN WC EVENT SHALL  NVIDIA OR ITS SUPPLIERS
...
/*----------------------------------------------------------------------------
         CHECK IF PIXEL IS IN SECTION OF SPAN WHICH GETS WC FILTERING
------------------------------------------------------------------------------
