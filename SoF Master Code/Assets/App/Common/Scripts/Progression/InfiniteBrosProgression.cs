...
public class InfiniteBrosProgression
{
    ...
    public void Load()
    {
        var jsonDataText = PlayerPrefs.GetString(GameState.me.id + "." + GameState.me.username + ".infinite_player_progression", "{}");
    ...
    {
        var jsonData = Serialize();
        PlayerPrefs.SetString(GameState.me.id + "." + GameState.me.username + ".infinite_player_progression", jsonData.ToString());
    }
