...
public class PearlyProgression
{
    ...
    public void Load()
    {
        var jsonDataText = PlayerPrefs.GetString(GameState.me.id + "." + GameState.me.username + ".pearly_player_progression", "{}");
    ...
    {
        var jsonData = Serialize();
        PlayerPrefs.SetString(GameState.me.id + "." + GameState.me.username + ".pearly_player_progression", jsonData.ToString());
    }
