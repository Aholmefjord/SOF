...
public class TangramPlayerProgression : MonoBehaviour {
    ...
    public void Load () {
        var jsonDataText = PlayerPrefs.GetString (GameState.me.id + "." + GameState.me.username + ".tangram_player_progression", "{}");
    ...
    public void Save () {
        var jsonData = Serialize ();
        PlayerPrefs.SetString (GameState.me.id + "." + GameState.me.username + ".tangram_player_progression", jsonData.ToString ());
    }
