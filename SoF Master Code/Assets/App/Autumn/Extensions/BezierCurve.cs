///
/// Generate bezier curves from a list of control points
/// Just need to call static method from Bezier class
/// i.e: List<Vector3> curve = Bezier.GenerateBezierInterpolate (List<Vector3> controlPoints)
///
...
public static class Bezier {
	[Obsolete ("Does not work. Consider using GenerateBezierInterpolate method instead")]
	public static List<Vector3> GenerateBezierSimple (List<Vector3> points) {
	...
	public static List<Vector3> GenerateBezierInterpolate (List<Vector3> points) {
		BezierPath bezierPath = new BezierPath ();
	...
	[Obsolete ("Does not work. Consider using GenerateBezierInterpolate method instead")]
	public static List<Vector3> GenerateBezierReduce (List<Vector3> points) {
		BezierPath bezierPath = new BezierPath ();
	...
	*/
	private class BezierPath {
		...
		private const float MINIMUM_SQR_DISTANCE = 1f;
		...
		*/
		public void Interpolate (List<Vector3> segmentPoints, float scale) {
			...
			// Two control points doesn't make a curve
